...
//Очистить список (удалить все элементы).
...
//Получить элемент по индексу (i-ый элемента).
...
//Добавить новый элемент (добавить после i-го элемента).
